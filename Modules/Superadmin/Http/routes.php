...
Route::group(['middleware' => ['web', 'SetSessionData', 'auth', 'language', 'timezone'],
    'namespace' => 'Modules\Superadmin\Http\Controllers'], function () {
        ...
        Route::post('/subscription/{package_id}/neweb-pay', 'SubscriptionController@confirmNewebPay')->name('subscription-confirm');
...
Route::any('/neweb-pay-notify', 'Modules\Superadmin\Http\Controllers\SubscriptionController@confirmNewebPayNotify');
