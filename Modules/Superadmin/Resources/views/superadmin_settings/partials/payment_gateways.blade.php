<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('NEWEB_ID', 'Neweb ID:') !!}
                {!! Form::text('NEWEB_ID', $default_values['NEWEB_ID'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('NEWEB_KEY', 'Neweb KEY:') !!}
                {!! Form::text('NEWEB_KEY', $default_values['NEWEB_KEY'], ['class' => 'form-control']); !!}
            </div>
        </div>
        <div class="col-xs-4">
            <div class="form-group">
                {!! Form::label('NEWEB_SECRET', 'Neweb Secret:') !!}
                {!! Form::text('NEWEB_SECRET', $default_values['NEWEB_SECRET'], ['class' => 'form-control']); !!}
            </div>
        </div>
