...
class BarcodesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Barcode::create([
            'id'=>6,
            'name'=>'每張 Continuous Rolls - 31.75mm x 25.4mm',
        ...
        // Barcode::create( [
        // 	'name'=>'每張 154 Per Sheet - (8.5" x 11")',
